...
- スピーカーのキャラクター
	- Nakajima：
        - 中島聡(ナカジマ サトシ)さん（1960年生まれ）は、日本を代表するエンジニア・起業家・エンジェル投資家。マイクロソフト本社でWindows 95やInternet Explorerの開発責任者を務め、「Windows 95の父」と呼ばれた。2000年に起業したソフトウェア会社Xevoを2019年に売却後、シンギュラリティ・ソサエティ代表として活動。投資家としても、NVIDIAなど将来有望な企業に早くから投資し、自身の著書で「メタトレンド投資」の手法を紹介している。
	- Minami：アナウンサー。若いが知性を感じる話し方。この番組を長く担当しており、ITや業界知識も豊富。中島さんとの掛け合いもスムーズ
...
- 番組の進行の仕方
    - 基本的には中島さんが解説する
    - Minamiはリアクション、合いの手、深い業界知識を生かした深堀の質問をする
